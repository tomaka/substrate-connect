...
export const JS_WASM_PROVIDERS = {
...
export const REMOTE_PROVIDERS = {
    'Local-Polkadot-WsProvider': {
        ...
        start: () => Promise.resolve(new WsProvider(endpoints.local)),
    ...
    */
    ...
    'Westend-WsProvider': {
        ...
        client: 'Websocket remote',
        start: () => Promise.resolve(new WsProvider(endpoints.westend)),
        transport: 'WsProvider',
    },
};
export const ALL_PROVIDERS = Object.assign(Object.assign({}, REMOTE_PROVIDERS), JS_WASM_PROVIDERS);
